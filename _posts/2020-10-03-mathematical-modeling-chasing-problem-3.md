...
1. 若猎犬在追击时提前做了预判——运动方向对准狐狸，并有 $\alpha$ 角度偏转，那追击情况又是如何？
...
<img src='/assets/images/2020-10-03-mathematical-modeling-chasing-problem-3/analysis.png' style='zoom:40%; margin: 0 auto; display: block;'/>

此外，猎犬追击狐狸的时间长短与预判角度有关。当预判角度超过某个数值，则追击时间会延长（例如猎犬运动角度偏转 60°，可能不太利于缩短追击时间）
