...
> 注：1. 上图给出的是小球沿着圆环的速率，角度的逆时针方向为正方向。  
>
> 2. 视频中给出的是一个周期内小球的速率和角度关系曲线。

考察小球从 A 到最低点 Q (即角度从 180°到 270° 变化) 过程中速率的变化，如下所示：

<img src='/assets/images/2020-04-23-vpython-simulation-ball-on-ring/v_angle.png' style='zoom:40%; margin: 0 auto; display: block;'/>

从上图中可以直观看出：从 A 点运动到 Q 点的过程中，速率先增大后减小，到达 Q 点 (对应上图 270° 位置 ) 的速率为 $\sqrt{2gR} = 4.47 m/s$。
