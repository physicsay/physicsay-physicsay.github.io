...
对于这个题，整个结构是对称的，可以从两个正电荷的中垂线处下手。我们发现，两个正电荷的合电场强度在中垂线上是沿着中垂线的，而负电荷就在中垂线上，在中垂线上的电场强度也是沿着中垂线的。可以通过对比距离点电荷远近 $r$ 来确定合场强为 0 的位置。
...
从图中(箭头处)可以看出，在 $y = -0.15$ 和 $y = 6.20$ 位置电场强度为 0。
...
从图中可以，除无穷远处电场强度为零，还有 2 个位置的电场强度大小也为 0。
...
## 2. 三个正点电荷
那么如果是三个正点电荷呢？照例绘制电场强度、电场强度大小分布 和 电势分布。
...
从图中可以看出，当三角形的顶点放置三个等量电荷时，除无穷远外，$y$ 轴方向仍有两个位置能使合场强为 0，分别为 $y = 0.24$ 和 $y = 0.57$。考虑对称性，共有四个位置使合场强为零。
